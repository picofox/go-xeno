...
func newSocketFileDescriptor(fd, family, sotype int, net string) *netFD {
	var ret = &netFD{}
	ret.fd = fd
	ret.network = net
	ret.family = family
...
func (c *SocketFileDescriptor) dial(ctx context.Context, laddr, raddr sockaddr) (err error) {
...
func (c *SocketFileDescriptor) connect(ctx context.Context, la, ra syscall.Sockaddr) (rsa syscall.Sockaddr, retErr error) {
